                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6">
                        <div class="services-section">
                            ...
                            <div class="services-description">
                                <p>Prosta nauka</p>
                                <p>Dzięki naszej aplikacji bardzo łatwo i szybko nauczysz się nowych słówek. Nauka jeszcze nigdy nie była tak przyjemna.</p>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="services-section">
                            ...
                            <div class="services-description">
                                <p>System powtórek</p>
                                <p>Nasze gry interaktywne pomogą ci łatwiej utrwalić wiedzę. Dzięki naszym grą inteaktywnym nowo poznane słowa na stałe zostaną w twojej pamięci.</p>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="services-section">
                            ...
                            <div class="services-description">
                                ...
                                <p>Aby korzystać z naszej aplikacji nie potrzebujesz niczego więcej niż tylko komputer. Możesz zacząć swoja naukę kiedy tylko chcesz.</p>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="services-section">
                            ...
                            <div class="services-description">
                                ...
                                <p>Już niebawem nasza aplikacja będzie dostepna na telefony z system Android i iOS. Więcej informacji niebawem.</p>
                            </div>
                        </div>
